...
import io.cjl.dialog.R
import io.cjl.dialog.`interface`.OnButtonClick
import io.cjl.dialog.`interface`.OnDialogButtonClickListener
...
class AlertDialog {
    ...
    companion object {
        ...
        fun show(context: AppCompatActivity, title: String, msg: String, btnLift: String?,  btnRight: String?, onOkButtonClickListener: OnDialogButtonClickListener?) {
            AlertDialog().bulid(context)
                .setTitle(title)
                .setMsg(msg)
                .setBtnL(btnLift, null)
                .setBtnR(btnRight, onOkButtonClickListener)
                .showDialog()
        }

        fun showClickLeft(context: AppCompatActivity, title: String, msg: String, btnLift: String?,  btnRight: String?, onCancelButtonClickListener: OnDialogButtonClickListener?) {
            AlertDialog().bulid(context)
                .setTitle(title)
                .setMsg(msg)
                .setBtnL(btnLift, onCancelButtonClickListener)
                .setBtnR(btnRight, null)
                .showDialog()
        }

        fun show(context: AppCompatActivity, title: String, msg: String, btnLift: String?,  btnRight: String?, onOkButtonClickListener: OnDialogButtonClickListener?,onCancelButtonClickListener: OnDialogButtonClickListener?) {
            AlertDialog().bulid(context)
                .setTitle(title)
                .setMsg(msg)
                .setBtnL(btnLift, onCancelButtonClickListener)
